...
> **本次工作階段（2026-06，已全部 commit）做完**：Media Quick Wins 三項（縮圖+片長 / context menu / 分享匯出，模擬器驗過）＋ 相機手動控制完整實作（FPS / EV / 手動曝光 ISO+快門 / 白平衡，ISO 段位制 + 快門角度制 + 60Hz 防閃爍）。**下次接著做的起點＝上面這個「待真機驗證」清單**（拿 iPhone 跑一輪），驗完再從 Short Term 往下挑。
